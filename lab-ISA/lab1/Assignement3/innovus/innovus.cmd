...
#  Created on Sat Nov 19 01:25:03 2022                
#                                                     
#######################################################
...
set init_top_cell myfilter
set init_verilog ../netlist/myfilter.v
...
setDrawView fplan
win
dumpToGIF ./ss_filter_ppr.fplan.gif
getDrawView
setDrawView amoeba
win
dumpToGIF ./ss_filter_ppr.amoeba.gif
getDrawView
setDrawView place
win
dumpToGIF ./ss_filter_ppr.place.gif
checkPlace checkplace.ss.rpt
dumpToGIF filter_post_place
reset_parasitics
extractRC
redirect -quiet {set honorDomain [getAnalysisMode -honorClockDomains]} > /dev/null
timeDesign -postRoute -pathReports -drvReports -slackReports -numPaths 50 -prefix myfilter_postRoute -outDir timingReports
redirect -quiet {set honorDomain [getAnalysisMode -honorClockDomains]} > /dev/null
timeDesign -postRoute -hold -pathReports -slackReports -numPaths 50 -prefix myfilter_postRoute -outDir timingReports
...
set_verify_drc_mode -disable_rules {} -check_ndr_spacing auto -check_only default -check_same_via_cell false -exclude_pg_net false -ignore_trial_route false -ignore_cell_blockage false -use_min_spacing_on_block_obs auto -report myfilter.drc.rpt -limit 1000
verify_drc
set_verify_drc_mode -area {0 0 0 0}
reportGateCount -level 5 -limit 100 -outfile myfilter.gateCount
saveNetlist myfilter.v
all_hold_analysis_views 
all_setup_analysis_views 
write_sdf  -ideal_clock_network myfilter.sdf
write_sdf -ideal_clock_network -recompute_delay_calc myfilter.sdf
reset_parasitics
extractRC
...
read_activity_file -format VCD -scope /tb_filter/UUT -start {} -end {} -block {} ../vcd/design.vcd
set_power -reset
set_powerup_analysis -reset
set_dynamic_power_simulation -reset
report_power -rail_analysis_format VS -outfile .//myfilter.rpt
report_power -outfile switching_activity_power_cons_ppr -sort { total }
